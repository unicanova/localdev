...
downloadFile() {
  ...
  MINIKUBE_VERSION=${MINIKUBE_VERSION:-$MINIKUBE_STABLE_VERSION}
  DOWNLOAD_URL="https://storage.googleapis.com/minikube/releases/${MINIKUBE_VERSION}/${DOWNLOAD_BINARY}-${OS}-${ARCH}"
